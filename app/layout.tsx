...
// ThinkPro Style: Lexend font for modern, friendly, rounded feel
const lexend = Lexend({
...
export const metadata: Metadata = {
  ...
  alternates: siteConfig.domain ? { canonical: siteConfig.canonicalPath } : undefined,
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {siteConfig.domain && (
          <link rel="canonical" href={`${siteConfig.domain}${siteConfig.canonicalPath}`} />
        )}
      </head>
