...
export const GROUPED_CATEGORIES = [
  ...
  [FEATURED_CATEGORIES[5], FEATURED_CATEGORIES[1]], // Mainboard, Case
  [FEATURED_CATEGORIES[3], FEATURED_CATEGORIES[10]], // CPU, RAM
  [FEATURED_CATEGORIES[13], FEATURED_CATEGORIES[6]], // Card màn hình, Màn hình
  [FEATURED_CATEGORIES[7], FEATURED_CATEGORIES[9]], // Ổ cứng, Nguồn
  [FEATURED_CATEGORIES[12], FEATURED_CATEGORIES[8]], // Tản nhiệt, Phụ kiện
